...
<div class="dropdown" style="position: fixed;margin-top: 65px; margin-left:20px;">
  <button class="btn btn-primary dropdown-toggle " data-toggle="dropdown" style="background:none; border: none; color: black;">Dropdown</button>
  <div class="dropdown-menu">
    <h5 class="dropdown-header" style="color:#000000; border-bottom: 2px solid rgb(1, 0, 0);
      ...
      border-radius: 5px;
      background-color: non;"> Psychological health </h5>

    <a class="dropdown-item" href="#text1">How to communicate effectively with your young child</a>
    <a class="dropdown-item" href="#Active-listening">1.Active listening</a>
    <a class="dropdown-item" href="#Reflective-listening">2.Reflective listening</a>
    <a class="dropdown-item" href="#Speaking-clearly">3.Speaking clearly</a>
    <a class="dropdown-item" href="#Avoiding-bribes">4.Avoiding bribes</a>
    <a class="dropdown-item" href="#Explaining-feelings">5.Explaining feelings</a>
    <a class="dropdown-item" href="#Using‘noticing’statements">6.Using ‘noticing’ statements</a>
    <a class="dropdown-item" href="#Having-fun-together">7. Having fun together</a>
    <a class="dropdown-item" href="#Focusing-on-behavior">8.Focusing on behavior</a>
    <a class="dropdown-item" href="#Leading by example">9.Leading by example</a>
    <a class="dropdown-item" href="#text2">What you need to know about parent-child attachment</a>
    <a class="dropdown-item" href="#text3">activities to develop a connection with your child</a>
    <a class="dropdown-item" href="#comment">Add your comment</a>

  </div>

</div>
 
  <img src="_com3.jpg" alt=""id="backimg" >
   
<div id="text1">
<pre style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">
<h1 ><B> How to communicate effectively with your young child : </B> </h1>
...
<ul><h2> Verbal communication is the way we communicate with words and includes:</h2>
<li>Pitch and tone of voice</li>
<li>The words you say</li> 
<li>Dialect, or using words your child can best understand.</li></ul>
<ul><h2 > Nonverbal communication is both :<br> intentional and unintentional communication through body language. It includes things like:</h2>
<li>Facial expressions</li> 
<li>Eye contact</li> 
<li>Personal space</li> 
<li>Hand gestures</li>
<li>Physical touch like a hug</li>
Try these nine tips to practice your verbal and nonverbal communication skills:
</ul>
<h2><B id="Active-listening"> 1.Active listening</B></h2>
 ...
 <h2><B id=" Reflective-listening">2.Reflective listening</B></h2>
A great way to show your child that you are paying attention and care about what they have to say is by acting like a mirror.
 ...
 <h2><B id="Speaking-clearly">3.Speaking clearly</B></h2>
Use language that is understandable for your child and appropriate to their age.
 ...
 <h2><B id="Avoiding-bribes">4.Avoiding bribes</B></h2>
...
<h2><B id="Explaining-feelings">5.Explaining feelings</B></h2>
...
<h2><B id="Using‘noticing’statements">6.Using ‘noticing’ statements</B></h2>
...
<h2><B id="Having-fun-together">7. Having fun together</B></h2>
...
<h2><B id="Focusing-on-behavior">8.Focusing on behavior</B></h2>
...
<h2><B id="Leading by example">9.Leading by example</B></h2>
...
<img src="communication (1).jpg" id="img2" style = "overflow-x: hidden;">;

</pre>
<pre style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;" id="text2">
  <h1><B>What you need to know about parent-child attachment:</B></h1>
 ...
 <h2><B>Why building a relationship with your child matters</B></h2>
...
the ground for children to grow up to become happy, independent adults. Loving, secure relationships help build resilience, our ability to cope with challenges and recover from setbacks.
 ...
 <h2><B>How to bond with your child</h2></B>
...
then you’ll be helping them to have a great start in life. Here are some ways that can help you build a strong connection with your child from the moment you meet.
 <ul>
 <li>
<B>Notice what they do.</B> When your baby or young child cries, gestures or babbles, respond appropriately with a hug, eye contact or words.
...
but it helps to build neural connections in your little one’s brain that support the development of communication and social skills.
 ...
 <li>
<B>Play together.</B> By playing with your child, you are showing them that they are valued and fun to be around.
...
<h2><B>Experiencing difficulties bonding with your child?</B></h2>
...
<img src="communication-2.jpg" id="img3">

<pre style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;" id="text3">
   <h1><B>  activities to develop a connection with your child<B></h2> 
   <h3><B>Eat, play, love: Loving ways to help build your child’s brain.</B></h3> 
...
<br>
<img src="2.jpeg" id="img_2">
<br>
<img src="3.jpeg" id="img_3">
<br>
<img src="4.jpeg" id="img_4">
<br>
<img src="5.jpeg" id="img_5">
<br>
<br>
<br>
<br>
...
<<div class="container center__display">
    <div class="top">
   <h2 id="comm" style="color: rgb(1, 3, 4);">Add your useful comment,please!</h2>
